 ...
 * 
 * Basically, when a result hasn't {@link #save(String, String, List) saved} yet in the cache, {@link #getOntologyTerms(String, String)}
...
public abstract class OntoTermDiscoveryCache extends OntologyTermDiscoverer
{
	 ...
	 * method {@link #getOntologyTerms(String, String)} will return the saved result, until the cache's internal decides
